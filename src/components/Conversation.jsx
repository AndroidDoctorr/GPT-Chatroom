...
const universalFormatMessage =
    'This is a chat conversation between multiple chat agents with different setup prompts, generated by an application given user input. The purpose is for training, simulations, test content generation, entertainment, etc. Each participant\'s message will begin with their name in all caps followed by ":" - this is added automatically by the app, so you don\'t have to include this part in your response. Your character will be defined with the [CHARACTER SETUP] prompt. Each character only sees their own setup prompt. Please respond only as this character. Do not include any formatting or your name, just the content of your character\'s response. Try to respond in character as best you can to the conversation. The human user will be named "HOST", and system messages will be named "SYSTEM". Again, DO NOT include the name in all caps at the beginning.'
